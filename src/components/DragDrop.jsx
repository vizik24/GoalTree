...
export default function DragDrop() {
    return(
        ...
        <AnimateOnScroll animationClass="visible">
          <h2 className='text-center text-5xl font-bold mb-12 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent'>Hierarchical Goal Setting.</h2>
        </AnimateOnScroll>
