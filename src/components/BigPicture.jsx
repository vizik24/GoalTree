      ...
      <div className="container mx-auto px-4">
        <AnimateOnScroll initialClass="scroll-animation-tiny" animationClass="visible">
          <div className="flex items-center justify-center mb-8">
            ...
            <h2 className='text-center text-5xl font-bold mb-12 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent'>See the bigger picture.</h2>
          </div>
